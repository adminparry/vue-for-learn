<template>
  <div class="login-container">
    <el-form ref="loginForm" class="login-form" :rules="loginRules" :label-position="pos" :size="size" :model="formLabelAlign">
      ...
      <el-form-item prop="password">
        <el-input placeholder="密码" ref="password" v-model="formLabelAlign.password" show-password></el-input>
      </el-form-item>
      <el-form-item prop="captcha">
        <el-input placeholder="验证码" v-model="formLabelAlign.captcha">
          <template slot="prepend"> <img @click="refesh($event)" class="captcha" src="/api/captcha" alt=""></template>
        </el-input>
      </el-form-item>
...
export default {
  ...
  methods:{
    github(){
      window.location.href = 'https://github.com/login/oauth/authorize?client_id=4b4cb5fb589adb60eae7';
